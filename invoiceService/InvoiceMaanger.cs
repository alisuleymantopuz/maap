...
using invoiceService.CommunicationChannels;
using invoiceService.Events;
...
namespace invoiceService
{
    public class InvoiceManager : IHostedService, IMessageHandlerCallback
    {
        ...
        private async Task SendInvoice(Customer customer, Invoice invoice)
        {
            ...
            body.AppendLine("<td>Maap GARAGE</td>");
            ...
            body.AppendLine(": Maap Garage<br/>");
            ...
            body.AppendLine("The Maap crew<br/>");

            body.AppendLine("</htm></body>");

            MailMessage mailMessage = new MailMessage
            {
                From = new MailAddress("invoicing@Maap.nl"),
                Subject = $"Maap Garage Invoice #{invoice.InvoiceId}"
            };
            mailMessage.To.Add("Maap@prestoprint.nl");
